    ...
    <el-table
      ...
      <el-table-column align="center" type="expand">
        <template slot-scope="scope">
          <el-col :span="14">
            <el-row>
              <el-tag style="margin-bottom: 8px">新闻id</el-tag>
              <span>{{ scope.row._id }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">新闻名称</el-tag>
            ...
            <el-row>
              <el-tag style="margin-bottom: 8px">新闻作者</el-tag>
              <span>{{ scope.row.tag }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">新闻阅读量</el-tag>
              <span>{{ scope.row.see }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">新闻评论数</el-tag>
      ...
      <el-table-column align="center" label="选项">
        <template slot-scope="scope">
          <el-button-group>
            ...
            <el-dialog :visible.sync="dialogFormVisible" title="编辑新闻">
              <el-form label-width="120px" style="margin: 8px">
                ...
                <el-form-item label="新闻阅读量"><el-input v-model="see" placeholder="请输入阅读量"/></el-form-item>
                <el-form-item>
